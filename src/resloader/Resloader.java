...
public class Resloader {
	...
	public static final Image heiji = new Image(ClassLoader.getSystemResource("heijionboard.png").toString());;
	public static final Image ginCard = new Image(ClassLoader.getSystemResource("gincard.jpg").toString());;
	public static final Image conanCard = new Image(ClassLoader.getSystemResource("Conancard.jpg").toString());;
	public static final Image shadowManCard = new Image(ClassLoader.getSystemResource("shadowmancard.jpg").toString());;
	public static final Image kogoroCard = new Image(ClassLoader.getSystemResource("kogorocard.jpg").toString());;
	public static final Image ranCard = new Image(ClassLoader.getSystemResource("rancard.jpg").toString());;
	...
	public static final Image haibaraability = new Image(
			ClassLoader.getSystemResource("haibaraability.jpg").toString());
	// public static final Image kidability = new
	// Image(ClassLoader.getSystemResource("kidability.jpg").toString());
